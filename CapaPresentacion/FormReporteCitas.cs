...
namespace CapaPresentacion
{
    public partial class FormReporteCitas : Form
    {
        ...
        private void FormReporteCitas_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.rvCitas.LocalReport.DataSources.Clear();
                ...
                this.rvCitas.LocalReport.DataSources.Add(rds);
                this.rvCitas.LocalReport.DataSources.Add(rdsM);
                this.rvCitas.LocalReport.DataSources.Add(rdsP);
                this.rvCitas.LocalReport.DataSources.Add(rdsE);
                this.rvCitas.LocalReport.DataSources.Add(rdsH);
                this.rvCitas.RefreshReport();
            }
            catch (Exception ex)
            {
